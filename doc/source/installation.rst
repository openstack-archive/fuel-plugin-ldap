...
#. `MU-1 (Maintenance Update) <https://docs.mirantis.com/openstack/fuel/fuel-8.0/maintenance-updates.html#maintenance-updates-for-mirantis-openstack-8-0>`_ should be installed to provide proper work of keystone providers ith domains during deployment process.
